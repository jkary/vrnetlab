...
class CAT9KV_vm(vrnetlab.VM):
    def __init__(self, hostname, username, password, conn_mode):
        ...
        self.gen_vswitch_xml()

    def gen_vswitch_xml(self):
        pass
    ...
    def gen_mgmt(self):
        ...
        res = super(CAT9KV_vm, self).gen_mgmt()
...
if __name__ == "__main__":
    ...
    vr = CAT9KV(args.hostname, args.username, args.password, args.connection_mode)
    vr.start()
